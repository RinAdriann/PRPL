...
progressRouter.post("/", auth, async (req, res) => {
    const { lessonId, percent } = req.body;
    if (!lessonId || percent == null)
...
// List own progress
progressRouter.get("/mine", auth, async (req, res) => {
...
progressRouter.get("/lesson/:lessonId", auth, async (req, res) => {
